""" This module allows the Othello/Reversi game to run in a webpage, using Flask. """
...
def home():
    """ Display the board """
    return render_template('othello_board.html', game_board=game_board)
...
def load_game():
    ...
    move_counter = game_state["move_counters"]
